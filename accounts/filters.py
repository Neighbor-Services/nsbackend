...
class ProfileFilter(django_filters.FilterSet):
    price_min = django_filters.NumberFilter(field_name="catalog_service__base_price", lookup_expr='gte')
    price_max = django_filters.NumberFilter(field_name="catalog_service__base_price", lookup_expr='lte')
