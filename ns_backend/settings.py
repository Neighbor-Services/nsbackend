...
CSRF_TRUSTED_ORIGINS = os.getenv('CSRF_TRUSTED_ORIGINS', 
    'https://neighborservice.com,https://www.neighborservice.com,https://api.neighborservice.com,https://staging.neighborservice.com,https://api.staging.neighborservice.com,http://localhost:3000,http://localhost:8000,http://localhost:8080'
).split(',')
