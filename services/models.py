...
class ServiceRequest(models.Model):
    ...
    longitude = models.DecimalField(max_digits=100, decimal_places=50, blank=True, null=True)
    latitude = models.DecimalField(max_digits=100, decimal_places=50, blank=True, null=True)
